...
def purchase_in_game_currency():
    try:
        ...
        response = requests.post(CURRENCY_PLAYER_URL+'/api/player/currency/', json=payload)
...
def decrease_in_game_currency(user_id):
    try:
        ...
        balance_response = requests.get(CURRENCY_PLAYER_URL+ f'/api/player/decrease/balance/{user_id}')
        ...
        response = requests.put(CURRENCY_PLAYER_URL+ f'/api/player/decrease/update_balance', json=payload)
...
def increase_currency(user_id):
    try:
        ...
        balance_response = requests.get(CURRENCY_PLAYER_URL + f'/api/player/increase/balance/{user_id}')
        ...
        response = requests.put(CURRENCY_PLAYER_URL+ f'/api/player/increase/update_balance', json=payload)
